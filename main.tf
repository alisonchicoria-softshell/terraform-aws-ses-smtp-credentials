...
module "secret" {
  source = "github.com/alisonchicoria-softshell/terraform-aws-secrets//secret?ref=v0.7.0"
...
module "rotation" {
  source = "github.com/alisonchicoria-softshell/terraform-aws-secrets//secret-rotation-function?ref=v0.7.0"
